  ...
  return (
    <>
      ...
      <section className="Maseeh-container">
        <p className="Generate-text">{generatedPlate.fruits}</p>
        <p className="Generate-text">{generatedPlate.vegetables}</p>
        ...
        <p className="Generate-text">{generatedPlate.grains}</p>
        <p className="Generate-text">{generatedPlate.protein}</p>
        <p className="Generate-text">{generatedPlate.dairy}</p>
      </section>
